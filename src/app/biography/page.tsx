      ...
      <div className="container relative z-10 px-4 py-12 mx-auto max-w-7xl">
        <div className="mb-6 text-center ">
          <h1 className="mb-3 text-4xl font-bold text-purple-800 font-utheemu">
            ބައޮގްރަފީއާއި ގުޅުންހުރި ފިލާވަޅުތައް
          </h1>
        ...
        <div className="mb-8">
          <div className="flex flex-wrap justify-center gap-3 mb-6">
            <button
              onClick={() =>
                setActiveCategory(
                  activeCategory === "ބައޮގްރަފީ" ? null : "ބައޮގްރަފީ"
                )
              }
              className={`flex items-center gap-2 px-5 py-2 text-white transition rounded-full ${
                activeCategory === "ބައޮގްރަފީ"
                  ? "bg-pink-600"
                  : "bg-pink-600 hover:bg-pink-700"
              }`}
            >
              <BookOpen size={16} />
              <span>ބައޮގްރަފީ</span>
            </button>
            <button
              onClick={() =>
